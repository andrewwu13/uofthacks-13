        ...
        "telemetry_batch": [
            {
                ...
                "acceleration": {"x": 15, "y": 10},
            },
            {
                "x": 200,
                "y": 250,
                "timestamp": 1100,
                "velocity": {"x": 420, "y": 210},
                "acceleration": {"x": 12, "y": 8},
            },
            {
                "x": 350,
                "y": 300,
                "timestamp": 1200,
                "velocity": {"x": 450, "y": 180},
            ...
            },
            {
                ...
                "y": 320,
                "timestamp": 1300,
                "velocity": {"x": 480, "y": 150},
                "acceleration": {"x": 8, "y": 3},
            },
            {
                "x": 650,
                "y": 350,
                "timestamp": 1400,
                "velocity": {"x": 500, "y": 120},
                "acceleration": {"x": 5, "y": 2},
            },
        ],
        "interactions": [
            {
                "type": "hover",
                "element_id": "hero-neobrutalist",
                "genre": "neobrutalist",
                "duration_ms": 800,
            },
            {
    ...
    return {
        ...
        "telemetry_batch": [
            ...
            },
            {
                ...
                "timestamp": 1400,
                "velocity": {"x": 45, "y": 35},
                "acceleration": {"x": 110, "y": 90},
            },
        ],
        "interactions": [
            {
                "type": "hover",
                "element_id": "hero-minimalist",
                "genre": "minimalist",
                "duration_ms": 4500,
            },
            {
                "type": "hover",
                "element_id": "grid-glassmorphism",
                "genre": "glassmorphism",
                "duration_ms": 3800,
            },
        ...
        "loud_module_events": [
            {
                "module_id": "loud-glassmorphism-1",
                "genre": "glassmorphism",
                "dwell_time_ms": 5000,
                "scroll_velocity": 50,
                "clicked": True,
...
def generate_indecisive_brutalist_user():
    ...
    return {
        ...
        "loud_module_events": [
            {
                "module_id": "loud-neobrutalist-bold",
                "genre": "neobrutalist",
                "dwell_time_ms": 6000,
                "scroll_velocity": 80,
                "clicked": True,
            ...
            {
                "module_id": "loud-minimalist-soft",
                "genre": "minimalist",
                "dwell_time_ms": 300,
                "scroll_velocity": 700,
                "clicked": False,
    ...
    try:
        ...
        for key, expected_val in expected.items():
            ...
            if actual == expected_val:
                ...
                mismatches.append(
                    f"  [N] {key}: expected={expected_val}, actual={actual}"
                )
