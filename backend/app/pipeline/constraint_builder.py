...
class ConstraintBuilder:
    ...
    def build(
        self, reducer_output: ReducerOutput, context: ReducerContext
    ) -> Constraints:
        """
        ...
        return Constraints(hard=hard, soft=soft, exploration_budget=exploration_budget)
    ...
    def _calculate_exploration_budget(self, reducer_output: ReducerOutput) -> float:
        ...
        tolerance_map = {"low": 0.1, "medium": 0.25, "high": 0.4}
