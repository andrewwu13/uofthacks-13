...
class MockRedisClient:
    ...
    async def set(
        self, key: str, value: str, ttl: int = None, ex: int = None, nx: bool = False
    ) -> bool:
...
def sample_motor_data():
    ...
    return [
        ...
        },
        {
            ...
            "velocity": {"x": 312.5, "y": 125},
            "acceleration": {"x": 19531, "y": 7812},
        },
        {
            "timestamp": 132,
            "position": {"x": 110, "y": 205},
            "velocity": {"x": 312.5, "y": 187.5},
            "acceleration": {"x": 0, "y": 3906},
        },
    ]
...
def sample_user_profile():
    ...
    return {
        ...
        "behavioral": {"speed_vs_accuracy": "balanced", "engagement_depth": "moderate"},
        "inferred": {
...
class MockSSEPublisher:
    ...
    async def publish_layout_update(self, session_id: str, layout_update: Dict):
        self.published_messages.append(
            {"session_id": session_id, "layout_update": layout_update}
        )
